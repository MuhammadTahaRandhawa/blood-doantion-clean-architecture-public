...
class DonationInfoWidget extends StatefulWidget {
  const DonationInfoWidget({super.key, required this.donation});
  final Donation donation;

  @override
  State<DonationInfoWidget> createState() => _DonationInfoWidgetState();
}

class _DonationInfoWidgetState extends State<DonationInfoWidget> {
  ...
  initState() {
    ...
    context
        .read<CommentsBloc>()
        .add(CommentsOnDonationFetched(widget.donation.donationId));
    context.read<RatingCubit>().emptyRatings();
    context
        .read<RatingsBloc>()
        .add(RatingsOnDonationFetched(widget.donation.donationId));
    super.initState();
  }
          ...
          children: [
            InkWell(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    title: Text(
                      AppLocalizations.of(context)!
                          .donationInfo_ratingCaluclated,
                      style: Theme.of(context).textTheme.titleMedium,
                    ),
                    content: Text(
                      AppLocalizations.of(context)!.donationInfo_RatingSolution,
                    ...
                    actions: [
                      TextButton(
                        ...
                        child: Text(
                            AppLocalizations.of(context)!.donationInfo_okBtn),
                      ),
                    ],
                  ),
              ...
              child: _infoItem(
                ...
                icon: Icons.star,
                subtitle: '${donationRatings.length}',
              ),
            ),
            _divider(),
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => CommentsPage(
                    commentType: CommentType.donation,
                    postId: widget.donation.donationId,
                  ),
                ));
              },
              child: _infoItem(
